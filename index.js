...
let owner ="713831710885806125";// sizin id'niz

bot.on("ready", guild => {
    bot.user.setActivity('youtube.com/spajki', { type: 'LISTENING'  })
...
bot.on('message', async msg => {
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle('Kazım/DJ | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("**Kazım/DJ |🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
